                    ...
                    <div class="flex flex-col gap-y-5">
                        ...
                        <div class="flex flex-col gap-y-2">
                            ...
                            <select name="category" id="category"
                                ...
                                <option value="Web Development"
                                    {{ old('category') == 'Web Development' ? 'selected' : '' }}>Web Development
                                </option>
                                <option value="App Development"
                                    {{ old('category') == 'App Development' ? 'selected' : '' }}>App Development
                                </option>
                                <option value="Graphic Design"
                                    {{ old('category') == 'Graphic Design' ? 'selected' : '' }}>Graphic Design</option>
                        ...
                        <div class="flex flex-col gap-y-2">
                            ...
                            <textarea name="about" id="about" cols="30" rows="10"
                                class="rounded-xl border border-gray-300 px-4 py-3 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                placeholder="Describe the project...">{{ old('about') }}</textarea>
                        </div>
